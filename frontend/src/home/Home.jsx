...
const Home = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="flex flex-col-reverse md:flex-row items-center justify-between px-4 md:px-12 py-20 md:py-24 gap-10">
        {/* Left Content */}
      ...
      <section className="bg-white px-4 md:px-12 py-16 md:py-20">
        ...
        <div className="relative flex items-center justify-center mb-12">
          {/* Horizontal line behind the buttons */}
